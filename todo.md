...
- [x] Fix React hooks error in employee SeatingPlan - moved useUtils() to top level
...
- [x] Audit current layout structure for fixed widths/heights and overflow issues
- [x] Fix EmployeeLayout sidebar for mobile/tablet - implement collapsible drawer
- [x] Optimize Dashboard grid for mobile (1 col), tablet (2 col), desktop (4 col)
- [x] Make cards and content touch-friendly with adequate padding/spacing
- [x] Fix tables to stack or scroll horizontally on small screens
- [x] Optimize forms for mobile with full-width inputs
